...
## Prelude
### Standard Encoding
Most AFRP implementations use the same encoding. Yampa in particular uses a GADT, however if you were to simplify said GADT down to its bare bones it would ultimately be the same encoding:
